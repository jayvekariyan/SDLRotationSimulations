...
int main(int argc, char *argv[])
{
    ...
    struct Point3D points3d[8];
    struct Point2D points2d[8];
    double l = a / 2;
    points3d[0] = (struct Point3D){l, l, l};    // B
    points3d[1] = (struct Point3D){l, l, -l};   // A
    points3d[2] = (struct Point3D){-l, l, -l};  // D
    points3d[3] = (struct Point3D){-l, l, l};   // C
    ...
    while (running)
    {
        ...
        DrawLineSeg(surface, points2d[1], points2d[5]);
        DrawLineSeg(surface, points2d[7], points2d[3]);
        DrawLineSeg(surface, points2d[7], points2d[4]);
        DrawLineSeg(surface, points2d[7], points2d[6]);
        DrawLineSeg(surface, points2d[2], points2d[3]);
        DrawLineSeg(surface, points2d[2], points2d[6]);
        DrawLineSeg(surface, points2d[5], points2d[4]);
        DrawLineSeg(surface, points2d[5], points2d[6]);
        DrawLineSeg(surface, points2d[0], points2d[3]);
        DrawLineSeg(surface, points2d[0], points2d[4]);
